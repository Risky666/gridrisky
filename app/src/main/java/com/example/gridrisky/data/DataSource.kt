package com.example.gridrisky.data
import com.example.gridrisky.R
import com.example.gridrisky.model.Topic
/*
import com.example.gridrisky.R: Ini digunakan untuk mengimpor resource
string dan drawable yang berada dalam file R dari package com.example.gridrisky
import com.example.gridrisky.model.Topic: Ini mengimpor kelas Topic dari package model.
Kelas ini digunakan untuk menyimpan data mengenai sebuah topik.
*/
object DataSource {
    val topics = listOf(
...
/*
   DataSource ini menyediakan kumpulan data topik yang akan
   digunakan dalam aplikasi untuk menampilkan daftar topik
   dalam grid layout atau list.
